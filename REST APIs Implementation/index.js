...
var delegationSchema = JSON.parse(fs.readFileSync(path.join('.', 'json_schemas', 'delegation_schema.json')).toString());
...
app.post('/api/films/public/:filmId/reviews/:reviewerId/delegation', isLoggedIn, validate({ body: delegationSchema }), reviewController.delegateReview);
app.delete('/api/films/public/:filmId/reviews/:reviewerId/delegation', isLoggedIn, reviewController.deleteDelegation);
